...
- 欢迎熟悉 Java 的爱好者提交 Issue/PR，或与我联系以接管项目的后续维护。
- 仓库地址：`https://github.com/QingJunXue/proxy-identity`

## 关于 Issue 提交

提交问题时请附上服务端类型与版本、Java 版本、插件版本、ProtocolLib 版本（如适用）、完整启动日志，以及 `config.yml` 中与问题相关的配置片段。
